document.addEventListener('DOMContentLoaded', () => {
    const events = [
        { name: 'Vernier Caliper', date: '1', description: '', modelUrl: 'https://maheshkurmi.github.io/experiments/vernier_calliper.html' },
        { name: 'MicroMeter', date: '2', description: '', modelUrl: 'https://maheshkurmi.github.io/experiments/micrometer.html' },{
            name:'Angle',date:'3',description:'',modelUrl:'https://www.visnos.com/demos/basic-angles'
        },
    ];
